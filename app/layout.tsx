...
export const metadata: Metadata = {
	...
	description:
		"Discover unique art pieces, custom murals, and contemporary installations at The Rare Haus. Pittsburgh-based art gallery specializing in transformative spatial design.",
	keywords: [
		"art gallery",
		"contemporary art",
		"murals",
	...
	twitter: {
		...
		title: "The Rare Haus | Luxury Art Gallery & Design Studio",
		description:
			"Discover unique art pieces, custom murals, and contemporary installations at The Rare Haus",
	},
	robots: {
		index: true,
		follow: true,
  ...
  return (
		<html lang="en" className="scroll-smooth">
			...
			<body
				...
				className="font-sans text-white bg-zinc-900 relative"
				style={{
					fontFamily:
			...
			>
				...
				<footer className="relative z-10 py-8 text-center text-sm text-zinc-400">
					<p>
						&copy; {new Date().getFullYear()} The Rare Haus. All
						rights reserved.
					</p>
				</footer>
			</body>
